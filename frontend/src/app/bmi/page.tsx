                    ...
                    <div className="lg:col-span-7 flex flex-col gap-8">
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Chiều cao (cm)</label>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Cân nặng (kg)</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                            value={weight}
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex flex-col items-center justify-center p-4 h-28 rounded-2xl transition-all border-2 ${goal === g.id
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col items-center justify-center h-[320px]">
                            ...
                            {bmi ? (
                                ...
                                <div className="w-48 h-48 rounded-full border-8 border-[#f2f4f3] flex items-center justify-center">
                                    <span className="text-gray-300 font-medium text-sm">Đang chờ dữ liệu...</span>
                                </div>
                            )}

                            <p className="text-center text-sm text-gray-500 mt-6 max-w-[200px]">
                                {bmi ? "Chỉ số BMI của bạn được tính dựa trên thông tin vừa nhập." : "Nhập chiều cao và cân nặng để xem chỉ số BMI của bạn."}
                            </p>
                        </div>
